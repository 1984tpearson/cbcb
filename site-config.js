...
(function (global) {
  ...
  const DEFAULTS = {
    ...
    image: {
      ...
      peoplePov: "One person only: the woman. The photograph is taken from the man's own eyes, so HE IS THE CAMERA and is never visible — no face, no head, no body, no clothing, not at the edge of frame. The only parts of him that may appear are the ones named on the CAMERA line.",
