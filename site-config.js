...
(function (global) {
  ...
  const DEFAULTS = {
    ...
    image: {
      ...
      peoplePov: "One person only: the woman. The photograph is taken from the man's own eyes: he IS the camera. CRITICAL — do not use the words \"the man\", \"he\" or \"his\" anywhere in the caption. Naming a man puts a second man in the picture, because the image generator cannot know he is the camera; it only sees that a man was described. Any part of him that appears in shot is written as \"the viewer's\" — the viewer's hand, the viewer's forearm, the viewer's chest, the viewer's cock — never as a man's. He has no face, head, body or clothing in this photograph; only the parts named on the CAMERA line exist.",
